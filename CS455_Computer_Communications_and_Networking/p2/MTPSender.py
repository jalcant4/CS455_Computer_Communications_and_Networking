...
def main():
	...
	# open the UDP socket
	sender_socket = unreliable_channel.socket(socket.AF_INET, socket.SOCK_DGRAM)
	client_address = (sender_ip, sender_port)
	sender_socket.bind(client_address)
